...
public class MainActivity extends AppCompatActivity
    ...
    private void setupViewPager() {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            } else fragments.add(ItemFragment.newInstance(i + 1));

            tabLayout.addTab(tabLayout.newTab().setText(getResources().getStringArray(R.array.tab_titles)[i]));
        }
        FragmentPagerAdapter adapter = new VPAdapter(getSupportFragmentManager(), fragments, getResources().getStringArray(R.array.tab_titles));
